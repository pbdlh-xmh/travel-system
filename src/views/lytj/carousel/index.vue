<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['lytj:carousel:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['lytj:carousel:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="carouselList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="轮播图图片URL" align="center" prop="imageUrl" />
      <el-table-column label="轮播图跳转链接" align="center" prop="linkUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="轮播图跳转链接" prop="linkUrl">
          <el-input v-model="form.linkUrl" placeholder="请输入轮播图跳转链接" />
        </el-form-item>
...
<script>
import { listCarousel, getCarousel, delCarousel, addCarousel, updateCarousel } from "@/api/lytj/carousel";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        linkUrl: [
          { required: true, message: "轮播图跳转链接不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除轮播图管理编号为"' + carouselIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('lytj/carousel/export', {
        ...this.queryParams
