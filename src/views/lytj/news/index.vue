  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="新闻配图" prop="imageUrl">
...
<script>
import { listNews, getNews, delNews, addNews, updateNews } from "@/api/lytj/news";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除旅游新闻编号为"' + newsIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('lytj/news/export', {
        ...this.queryParams
